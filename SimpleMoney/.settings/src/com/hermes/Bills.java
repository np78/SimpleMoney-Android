...
public class Bills extends Activity{
        ...
        else
        {
        	for(int i = 0; i < unpaidBills.length; i++)
	        {
	        	...
	        	try {
	    			...
	    			Log.e("Unpaid Bill Unable to retrieve photo", e.getMessage());
	    		}
        	...
        	for(int i = 0; i < paidBills.length; i++)
	        {
	        	...
	        	if(trans.getComplete())
	        	{
		        	...
		        	try {
		    			...
		    			Log.e("Paid Bill Unable to retrieve photo", e.getMessage());
		    		}
		        	tv.append(" " + trans.getRecipient().getName() + "  (" + trans.getRecipientEmail() + ")\n");
		        	String date = trans.getCreateDate();
		        	tv.append(" " + trans.getCreateDate() + "\n");
	...
	public void updateView(View view)
	{
		try
    	{
    		...
    		Log.e("Unable to retrieve bill data",e.getMessage());
    	}
	}
